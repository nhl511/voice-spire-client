    ...
    <div className="pdta-container">
      <div className="pdta-card">
          ...
          <div className="pdta-info-right">
            <div className="pdta-text-description">
              <span>
                ...
                voluptas nulla pariatur? [33] At vero eos et accusamus et iusto
            ...
            <div className="pdta-text-detail">
              <span>
                ...
                eum fugiat, quo voluptas nulla pariatur? [33] At vero eos et
        ...
        <div className="pdta-button">
          <button className="pdta-deny">Từ chối</button>
          <button className="pdta-accept">Chấp nhận</button>
        </div>
      </div>
    </div>
  );
